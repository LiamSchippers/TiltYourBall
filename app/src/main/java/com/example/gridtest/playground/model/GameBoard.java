...
public abstract class GameBoard extends Observable {
	...
	public void getCoordinateObject(float xLeftBound, float yLeftBound, float xRightBound, float yRightBound, float xUpperBound, float yUpperBound, float xDownBound, float yDownBound) {
